...
def get_candidate_details(candidate_id: int):
    ...
    try:
        with get_db() as cursor:
            ...
            # Get all interviews with scores - use %s for MySQL
            cursor.execute("""
...
def compare_candidates(candidate_ids: str):
    ...
    try:
        ...
        with get_db() as cursor:
            ...
            for cid in ids:
                # Get candidate with latest assessment - use %s for MySQL
                cursor.execute("""
